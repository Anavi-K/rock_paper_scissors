let rockUser = document.getElementById("UserRock");
let paperUser = document.getElementById("UserPaper");
let scissorsUser = document.getElementById("UserScissors");

let rockComp = document.getElementById("CompRock");
let paperComp = document.getElementById("CompPaper");
let scissorsComp = document.getElementById("CompScissors");
